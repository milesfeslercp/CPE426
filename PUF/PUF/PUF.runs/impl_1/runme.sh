...
HD_PWD='C:/Users/miles/Documents/CPE426/PUF/PUF/PUF.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ringOscillatorWithLED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ringOscillatorWithLED.tcl -notrace
